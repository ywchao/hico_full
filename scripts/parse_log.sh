...
grep 'Test net output #0' aux.txt | awk '{print $11}' > aux00.txt
grep 'Test net output #1' aux.txt | awk '{print $11}' > aux01.txt
grep 'Test net output #2' aux.txt | awk '{print $11}' > aux02.txt
grep 'Test net output #3' aux.txt | awk '{print $11}' > aux03.txt
grep 'Test net output #4' aux.txt | awk '{print $11}' > aux04.txt
grep 'Test net output #5' aux.txt | awk '{print $11}' > aux05.txt
...
# Generating
echo '#Iters Seconds TestSensitivity TestSpecificity TestHarmmean TestPrecission TestF1Score TestLoss'> $LOG.test
# paste aux0.txt aux4.txt aux1.txt aux2.txt | column -t >> $LOG.test
# rm aux.txt aux0.txt aux1.txt aux2.txt aux3.txt aux4.txt
paste aux0.txt aux4.txt aux00.txt aux01.txt aux02.txt aux03.txt aux04.txt aux05.txt | column -t >> $LOG.test
rm aux.txt aux0.txt aux3.txt aux4.txt aux00.txt aux01.txt aux02.txt aux03.txt aux04.txt aux05.txt
